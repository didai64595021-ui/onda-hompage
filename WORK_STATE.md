...
## 현재 작업
서비스별 광고 스케줄 개별 제어 (14개 서비스) — 완료 (2026-04-02)

### Phase 8: 서비스별 광고 스케줄 개별 제어 — 완료 (2026-04-02)
- [x] Step 1: Supabase 스키마 변경 (product_id 칼럼 추가, UNIQUE 제약조건 day_of_week+hour+product_id)
- [x] Step 2: ad-scheduler.js 수정 (서비스별 개별 스케줄 조회 + 폴백 + 서비스별 상태 추적)
- [x] Step 3: 대시보드 UI (서비스 선택 드롭다운 + 폴백 반투명 표시 + 프리셋 보완 + 서비스별 상태 요약)
