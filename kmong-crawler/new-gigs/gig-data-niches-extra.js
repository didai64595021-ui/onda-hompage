...
const EXTRA = {
  ...
  'N01': {
    ...
    //   - 카테고리 옵션 7개: 개인/경매부동산/기업/다국어/비영리/커뮤니티/포트폴리오
    //   - 팀 규모: 1인/2인이상/5인이상/30인이상
    //   - 상주 여부: 상주 가능/상주 불가능
    //   - 플러그인 설치: 0~10개 (STD/DLX/PRM)
    //   - 업종/기술 수준: dynamic 로드 (드롭다운 열 때 옵션 생성)
    extraSelects: [
      { label: '업종', value: '서비스업' },      // dynamic — fallback 있음
      { label: '카테고리', value: '기업 홈페이지' }, // 자영업자 대상 — "기업 홈페이지"가 실측 옵션 중 가장 적합
      { label: '플러그인 설치', value: '0개', nth: 0 },  // STD
      { label: '플러그인 설치', value: '2개', nth: 1 },  // DLX
      { label: '플러그인 설치', value: '5개', nth: 2 },  // PRM
    ],
  },
};
