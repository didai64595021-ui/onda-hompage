...
★ customer_facts 필수 추출 규칙 (절대 누락 금지) ★
다음 카테고리 중 메시지·대화 히스토리에서 언급된 건 **무조건** customer_facts에 넣으세요:
- 업종/업태: "치과", "미용실", "1인 원장", "B2B 제조", "법무법인" 등
- 규모: "30명 직원", "2개 지점", "연 매출 5억", "1인 사업자"
- 지역: "전주", "서울 강남", "부산 해운대"
- 현재 플랫폼/상태: "아임웹으로 만든 사이트", "카페24 사용 중", "워드프레스", "홈페이지 없음"
- 참고/예시 사이트: "https://...", "네이버 블로그에 있어요"
- 예산 신호: "20만원 예산", "최대한 저렴하게", "예산 충분"
- 기간 신호: "다음주까지", "이번 달 내", "급하지 않음"
- 페이지/기능 요구: "메인 + 서브 3개", "인스타 연동 필수"
- 과거 경험/불만: "이전에 비싸게 했는데", "템플릿 말고 직접 만들고 싶음"

facts 포맷은 "{카테고리}: {값}" 형태로 ("업종: 1인 원장 치과" / "지역: 전주" / "규모: 30명 직원"). 짧고 구체적으로.
facts가 답변 개인화의 핵심 — 비어있으면 답변이 뻔한 일반론으로 떨어짐.
