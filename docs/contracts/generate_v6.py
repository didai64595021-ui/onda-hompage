...
add_title('(안전보장형)', 14)
doc.add_paragraph()
add_text('"갑"과 "을"은 [ 2026-03-27 ] 아래와 같이 온라인 마케팅 계약을 체결한다.')
...
add_text('① 본 계약의 기간은 [ 2026-04-01 ] 부터 [ 2026-04-30 ] 까지 [ 1 ]개월로 한다.')
...
# === 제5조 (★ 완화안 #2 반영: 연체 7→10영업일, 재셋업비 삭제) ===
...
# === 제6조 (★ 완화안 #5 반영: 예외사유 시 대응방안 제시 의무) ===
...
# === 제11조 (★ 완화안 #1 반영: "해지 불가" 문구 제거, 톤 완화) ===
